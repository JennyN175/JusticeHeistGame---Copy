...
public class CameraButton2 : MonoBehaviour
{
    ...
    void Start()
    {
        cameraPromptSprite = GameObject.Find("camera_prompt2");
        thePlayer = GameObject.FindGameObjectWithTag("Player");
        playerScript = thePlayer.GetComponent<player>();
        cameraFOVScript = GameObject.Find("cameraViewPoint2").GetComponent<CameraFOV>();
