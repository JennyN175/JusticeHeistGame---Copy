...
public class CameraButton3 : MonoBehaviour
{
    ...
    void Start()
    {
        cameraPromptSprite = GameObject.Find("camera_prompt3");
        thePlayer = GameObject.FindGameObjectWithTag("Player");
        playerScript = thePlayer.GetComponent<player>();
        cameraFOVScript = GameObject.Find("cameraViewPoint3").GetComponent<CameraFOV>();
